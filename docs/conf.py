...
"""
wagmail documentation build configuration file.
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Build, send & schedule emails from the Wagtail admin',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'wagmail'),
                os.path.join(root_path, 'wagmail/migrations')])
